...
Welcome to the first newsletter from Security Without Borders. This is a regular newsletter covering recent cyber security issues, tools and events relevant for activists, dissidents, journalists and civil society at large.
...
- **Wordpress**: Sites running the popular Wordpress content management system are constantly probed by all sorts of attackers and are commonly compromised to serve malicious content. If your website runs Wordpress, it is vital that you always run the most recent versions of both Wordpress and any plugins and themes. The Wordpress Dashboard shows what version is running, and shows an update alert when a new version is available. The most recent version is 4.7.2 which is a security fix released on 10 January, intending to resolve a number of vulnerabilities in the software and in some of its plugins (PHPMailer, particularly). Wordpress developers also provide a guide on [how to harden your Wordpress installation](https://codex.wordpress.org/Hardening_WordPress).

- **Firefox and Thunderbird**: In the last few days, Mozilla has issued security fixes for both [Firefox](https://www.mozilla.org/en-US/security/advisories/mfsa2017-01/) and [Thunderbird](https://www.mozilla.org/en-US/security/advisories/mfsa2017-03/). There are currently no public reports of these vulnerabilities being exploited by attackers, and normally both Firefox and Thunderbird automatically download security updates. Just in case, make sure you're running the latest versions, which are 51 for Firefox and 45.7 for Thunderbird. You can find out which version you are running by going to _Help > About Firefox_ and _Help > About Thunderbird_ respectively.
Some recent changes in Firefox mean that it is possible you see warnings about certificates and/or password submission on some websites. It is important that you do NOT ignore these warnings and do not proceed. At the very least ask a trusted security expert before proceeding.

- **Apple**: In January, Apple also released numerous security updates for their primary products, including [macOS](https://support.apple.com/en-us/HT201222) as well as [iPhone iOS](https://support.apple.com/en-us/HT207482), which saw the release of version 10.2.1. If you haven't done so already, make sure you have installed all available updates, as they fix critical vulnerabilities. To update your Mac, read '[how to update your software](https://support.apple.com/en-us/HT201541)'. For iPhones, you can update to the latest version through _Settings > General > Software Update_.

- **Flash Player and Adobe Reader**: In January, Adobe released multiple updates to fix critical vulnerabilities in Flash Player and Adobe Reader, including their browser plugins and extensions. Flash Player and Adobe Reader have become mostly superfluous with the progress of mainstream browsers (particularly Google Chrome and Firefox) and with the advent of modern web technology. Quite frankly, we recommend uninstalling both Flash Player and Adobe Reader. Modern sites will mostly work as expected, and overall computer security will be greatly improved.
...
- An [extensive list of security resources](https://medium.com/tinfoil-press/current-digital-security-resources-5c88ba40ce5c#.khzgl4l92) for journalists, lawyers, activists and other groups has been published by Martin Shelton. The resource list is quite extensive, but if you are aiming at improving your security level you will certainly find helpful information there.


## Upcoming Events

- 4 February: [SeoulTechSociety Key Signing and Security Party](https://www.meetup.com/seoul-tech-society/events/237311039/), Seoul, South Korea
